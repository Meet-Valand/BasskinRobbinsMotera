...
export default function BackgroundSlideshow() {
  ...
  return (
    <div className={`${sourGummy.className} relative min-h-screen flex flex-col justify-center items-center overflow-y-auto bg-black text-white`}>
      ...
      <footer className="absolute top-200 flex space-x-6 bg-white/10 px-4 py-2 rounded-full">
        {[
      ...
      <p className="text-xl top-70 left-22 text-black relative">* We accept bulk orders</p>
      </div>
